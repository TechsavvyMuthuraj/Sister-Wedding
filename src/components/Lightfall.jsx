...
const Lightfall = ({
  ...
  dpr,
  paused = false,
  colors = ['#f59e0b', '#f43f5e', '#fbbf24', '#e11d48'],
  ...
  useEffect(() => {
    ...
    const effectiveStreakCount = isMobile ? Math.min(2, streakCount) : streakCount;
    const effectiveDensity = isMobile ? Math.min(0.35, density) : density;
    ...
    const uniforms = {
      ...
      uSpeed: { value: speed },
      uStreakCount: { value: Math.max(1, Math.min(16, Math.round(effectiveStreakCount))) },
